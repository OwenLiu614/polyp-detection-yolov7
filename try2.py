...
# 替换 Tkinter 选择文件，改用命令行参数
parser = argparse.ArgumentParser(description="YOLOv7 Polyp Detection")
parser.add_argument("--file", type=str, required=True, help="Path to image or video file")
args = parser.parse_args()

file_path = args.file  # 直接从命令行获取文件路径
